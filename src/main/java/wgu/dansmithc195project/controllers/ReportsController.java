...
public class ReportsController {
    ...
    @FXML private TableColumn<?, ?> numLoginAttemptsCol;
    @FXML private TableColumn<?, ?> numLoginAttemptsMonthCol;
    @FXML private TableColumn<?, ?> numLoginAttemptsUserCol;
    @FXML private TableColumn<?, ?> startCol;
    @FXML private TableView<?> tableLoginAttemptsReport;
